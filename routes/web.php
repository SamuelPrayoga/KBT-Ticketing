...
Route::middleware(['auth'])->group(function () {
    ...
    Route::middleware(['penumpang'])->group(function () {
        Route::get('/pesan/{data}', [App\Http\Controllers\PemesananController::class, 'pesan'])->name('pesan');
        ...
        Route::get('/show', [App\Http\Controllers\PemesananController::class, 'show'])->name('show');
    });
});
