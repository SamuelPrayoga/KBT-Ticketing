...
@section('content')
            ...
            <div class="card-body">
                <table class="table">
                    ...
                    <tr style="border-top: 1px solid #e3e6f0;">
                        ...
                        <td>Ubah Nomor Telepon/Whatsapp</td>
                        <td class="text-right">
                            <button type="button" class="btn btn-primary btn-sm" data-toggle="modal"
                                data-target="#ubah-telepon">
                                Ubah
                            </button>
                        </td>
                    </tr>
    ...
    <!-- Ubah Telepon Modal -->
    <div class="modal fade" id="ubah-telepon" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Ubah Nomor Telepon/Whatsapp</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form action="{{ route('edit.telepon') }}" method="POST">
                    @csrf
                    <div class="modal-body">
                        <div class="form-group">
